...
namespace Admin\DataBundle\Command;
...
use Admin\DataBundle\Command\Helper\DialogHelper;
use Admin\DataBundle\Generator\DoctrineCrudGenerator;
use Admin\DataBundle\Generator\DoctrineFormGenerator;
...
EOT
    ...
    {
        $dialog = $this->getDialogHelper();
        $dialog->writeSection($output, 'Welcome to the Roy-RC Doctrine2 CRUD generator');
    ...
    protected function getFormGenerator($bundle = null)
    {
        if (null === $this->formGenerator) {
            $this->formGenerator = new \Admin\DataBundle\Generator\DoctrineFormGenerator($this->getContainer()->get('filesystem'));
